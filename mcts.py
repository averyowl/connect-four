...
def mcts_factory(iterations: int) -> Callable[[list[int], Board, str, str], int]:
    def inner(actions: list[int], state: Board, my_symbol: str, opponent_symbol: str) -> int:
        best: dict[int, int] = {}
        for i in actions:
            best[i] = 0
